...
public:
  ...
  inline float GetScrollX() const { return mScrollX; }
  inline float GetScrollY() const { return mScrollY; }
  ...
  inline void SetOffsetX(float offsetX) { mOffsetX = offsetX; }
  inline void SetOffsetY(float offsetY) { mOffsetY = offsetY; }

  inline void SetScroll(float scrollX, float scrollY) {
    mScrollX = scrollX;
    mScrollY = scrollY;
  }
  inline void SetScrollX(float scrollX) { mScrollX = scrollX; }
  inline void SetScrollY(float scrollY) { mScrollY = scrollY; }
