...
OpenGLShader::~OpenGLShader() { glDeleteProgram(m_ProgramID); }

void OpenGLShader::Bind() const { glUseProgram(m_ProgramID); }

void OpenGLShader::Unbind() const { glUseProgram(0); }

std::string OpenGLShader::GetName() const { return m_Name; }

void OpenGLShader::UniformMat4(const std::string &uniformName,
                               const glm::mat4 &value) {
  int location = glGetUniformLocation(m_ProgramID, uniformName.c_str());
  glUniformMatrix4fv(location, 1, GL_FALSE, glm::value_ptr(value));
}

void OpenGLShader::UniformVec3(const std::string &uniformName,
                               const glm::vec3 &value) {
  int location = glGetUniformLocation(m_ProgramID, uniformName.c_str());
  glUniform3f(location, value.x, value.y, value.z);
}

void OpenGLShader::UniformFloat(const std::string &uniformName,
                                const float value) {
  int location = glGetUniformLocation(m_ProgramID, uniformName.c_str());
...
void OpenGLShader::UniformVec4(const std::string &uniformName,
...
OpenGLShader::Pairser(std::string &file) {
