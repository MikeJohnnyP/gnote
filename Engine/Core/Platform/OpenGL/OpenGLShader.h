...
class OpenGLShader : public Shader
{
  public:
    ...
    virtual void SetVec4(const std::string &uniformName, const glm::vec4 &value) override
    {
    ...
    virtual void SetInt(const std::string &uniformName, const int value) override
    {
